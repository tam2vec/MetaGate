...
| --- | --- | --- |
| Packaged DataHub plugin | Browser extension prototype, DataHub panel contract, and automatic URN-detection flow exist. A production DataHub package is still future work. | "The automatic UX is proven through a browser extension prototype; DataHub packaging is the next integration step." |
