...
| Independent benchmark | Two reviewers labeled 8 demo decisions with 8/8 agreement. CSV template, scorer, protocol, reviewer request, and unsafe-answer reduction benchmark framing are included. More labels are still needed before any production claim. | "Curated benchmark passes; early external agreement exists on 8 demo labels; this is not a production accuracy claim." |
