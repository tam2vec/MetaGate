...
| Public API fixture demo | Public Netlify page can call the Render API at `https://predicate-ixz0.onrender.com` using sanitized fixture data. | "Hosted page is API-backed with sanitized fixture data. Real DataHub proof runs locally or in a private deployment." |
