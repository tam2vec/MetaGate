(function () {
  ...
  function createPredicatePanel(decision) {
    ...
    var failedTerms = (
      decision.action_predicate && decision.action_predicate.failed_terms
        ? decision.action_predicate.failed_terms
        : []
    );

    var root = document.createElement("section");
    root.setAttribute("data-predicate-panel", "true");
    ...
    root.innerHTML = [
      "<div style='color:#617086;font-size:12px;font-weight:800;text-transform:uppercase'>Predicate</div>",
      ...
      "<a href='#predicate-full-review' style='display:flex;justify-content:center;align-items:center;height:40px;border-radius:8px;background:#315fd8;color:white;text-decoration:none;font-weight:800;margin-top:14px'>Open Full Review</a>"
    ].join("");

    return root;
  }

  window.PredicatePanel = {
    create: createPredicatePanel
  };
})();
