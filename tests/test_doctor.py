...
from predicate.doctor import check_url
...
class DoctorTest(unittest.TestCase):
    def test_http_error_still_proves_endpoint_is_reachable(self):
        ...
        with patch("predicate.doctor.urlopen", side_effect=error):
    ...
    def test_network_failure_is_reported_as_not_ready(self):
        with patch("predicate.doctor.urlopen", side_effect=OSError("connection refused")):
